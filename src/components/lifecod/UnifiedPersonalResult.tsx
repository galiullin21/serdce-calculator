  ...
  return (
    <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border-2 border-primary/20 rounded-2xl p-6 text-center space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        {accessLevel === 'free' && (
          <>
            <Button variant="outline" size="lg" onClick={() => window.open("https://t.me/galiullin_ruzal", "_blank")}>
              Стандарт — полный разбор
            </Button>
            <Button size="lg" className="bg-primary text-primary-foreground" onClick={() => window.open("https://t.me/galiullin_ruzal", "_blank")}>
