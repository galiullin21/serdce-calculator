...
export function FinancialCodeResultComponent({ result, name, onReset }: Props) {
  const cards = [
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="gradient-card rounded-2xl p-6 border border-border mb-6">
        ...
        <Accordion type="single" collapsible defaultValue="talent">
          {cards.map((card, i) => (
            <AccordionItem key={i} value={['talent', 'resource', 'mission', 'block'][i]} className="border-border">
