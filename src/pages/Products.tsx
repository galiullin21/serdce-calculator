...
const products = [
  {
    id: "psychology",
    title: "Психология",
    description: "Консультации, которые возвращают внутреннюю устойчивость и опору.",
    icon: Brain,
  ...
  },
  {
    ...
    description: "Анализ чисел и паттернов поведения. Осознанность через структуру.",
    icon: Calculator,
    action: "Узнать подробнее",
  ...
  },
  {
    id: "esotericism",
    title: "Эзотерика",
    description: "Эзотерика для жизни: осознанность, энергия, сила выбора.",
    icon: Sparkles,
    action: "Узнать подробнее",
  ...
  },
  {
    ...
    description: "Медитации для восстановления фокуса и покоя.",
    icon: Heart,
    action: "Узнать подробнее",
